        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                            ...
                            <div class="tab-pane fade pt-4" id="contato" role="tabpanel" aria-labelledby="contato-tab">
                                ...
                                <div class="row mb-1">                                    
                                    <div class="col-12 col-sm-6">                                        
                                        ...
                                        <div id="box_search_ccusto_os" class="box_search"></div>                              
                                    </div>   
                                    ...
                                    <div class="col-12 col-sm-6">                                        
                                        ...
                                        <div id="box_search_pcontas_os" class="box_search"></div>                              
                                    </div>  
                                </div>
                                ...
                                <div class="row mb-1">                                    
                                    <div class="col-12 col-sm-6">                                        
                                        ...
                                        <div id="box_search_ccusto_cupom" class="box_search"></div>                              
                                    </div>   
                                    ...
                                    <div class="col-12 col-sm-6">                                        
                                        ...
                                        <div id="box_search_pcontas_cupom" class="box_search"></div>                              
                                    </div>  
                                </div>                                
                            </div>
                            ...
                            <div class="tab-pane fade pt-4" id="endereco" role="tabpanel" aria-labelledby="endereco-tab">
                                ...
                                <div class="row mb-1">
                                    <div class="col-12 col-sm-8">                                        
                                        ...
                                        <div id="box_search_cliente_vendas" class="box_search"></div>                              
                                    </div>  
                                </div>                                
                                <div class="row mb-1">
                                    <div class="col-12 col-sm-8">                                        
                                        ...
                                        <div id="box_search_cliente_transferencia" class="box_search"></div>                              
                                    </div>  
                                </div>                                
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-sm btn-info" type="sumbit" id="editSalvar">Salvar Registro</button>
                </div>
            </div>
        </div>
    </div>
