        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Cadastro/Edição de centro_custo</h5>
                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <div class="row mb-1">
                            <div class="col-12 col-sm-12">
                                <div class="form-group"><label for="chave">Chave:</label><input type="text" id="edt_chave" name="chave" class="form-control form-control-sm" maxlenght="10" /></div>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-12 col-sm-12">
                                <div class="form-group"><label for="chavepai">Chavepai:</label><input type="text" id="edt_chavepai" name="chavepai" class="form-control form-control-sm" maxlenght="10" /></div>
                            </div>
                        </div>
